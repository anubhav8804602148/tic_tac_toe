...
public class MainScreen extends javax.swing.JFrame {
    ...
    void check_winner(){
        String[] arr = {
            jButton3.getText(),jButton1.getText(),jButton2.getText(),
            jButton6.getText(),jButton4.getText(),jButton5.getText(),
            jButton9.getText(),jButton7.getText(),jButton8.getText()
        };
        if(arr[0].equals("X")){
